...
app.controller('TComposerCtrl',
    ["$scope", "UXService", "Restangular", "Pusher", "AppService", "PostService", "$mdToast", "Me", "Upload", "apiBase", "$timeout", "$document", "EmojioneService", "$q", function($scope, UXService, Restangular, Pusher, AppService, PostService, $mdToast, Me, Upload,
